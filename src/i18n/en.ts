...
const en =  {
    ...
    "contactEmail": "Contact Email: info@taskaround.io",
    ...
    sections: {
      "1": {
        ...
        "a": {
          ...
          "notes": [
            "Some features of the Application may require registration. You may still use certain parts of the Application without registering.",
            "We may also use your information to communicate with you for customer support, updates, legal notices, or promotional content.",
          ],
        },
        "b": {
      ...
      "3": {
        ...
        "items": [
          ...
          "Provide personalized and location-based features",
    ...
    "4": {
      ...
      "items": [
        {
          "label": "Consent",
          "description": "when you voluntarily provide data or enable location",
        },
        {
          "label": "Contractual necessity",
          "description": "to deliver the Application and its core services",
        },
        {
          "label": "Legitimate interest",
          "description": "to improve our services, prevent fraud, and secure our infrastructure",
        },
        {
          "label": "Legal obligation",
          "description": "to comply with applicable laws",
        },
      ],
    },
    "5": {
    ...
    "6": {
      ...
      "text": "We use third-party tools for analytics, crash reporting, and geolocation:",
      "items": [
        {
      ...
      "note": "These services may collect information in accordance with their own privacy policies.",
    },
    "7": {
      "title": "7. Data Retention",
      "text": "We retain:",
      "items": [
        "User Provided Data: as long as your account is active or as needed for the purposes outlined",
        "Automatically Collected Data: for up to 24 months, or in aggregated form thereafter",
      ],
      "note": "You can request deletion by contacting us at info@taskaround.io. We will process requests within a reasonable time. Some information may be retained as required by law or for legitimate business needs.",
    },
    "8": {
      "title": "8. Your Rights (GDPR)",
      "text": "If you are located in the EEA or another jurisdiction with similar rights, you may:",
      "items": [
      ...
      "note": "To exercise these rights, contact us at info@taskaround.io.",
    },
    "9": {
      "title": "9. Opt-Out Rights",
      "items": [
        "You may stop all collection of information by uninstalling the Application using your device’s standard procedures.",
        "You can also disable location collection and push notifications in your device or app settings.",
      ],
    },
    "10": {
      "title": "10. Children and Age Restrictions",
      "text": "This Application is not intended for anyone under the age of 18. We do not knowingly collect or solicit personal information from individuals under 18.",
      "note": "If we learn that we have inadvertently collected personal data from someone under 18, we will delete it immediately. Parents or guardians who believe their child has provided us with information should contact us at info@taskaround.io.",
    },
    "11": {
      "title": "11. Security",
      "text": "We take appropriate technical and organizational measures to safeguard your information, including:",
      "items": [
        "Encryption in transit",
        "Access controls and authentication",
        "Secure data storage practices",
      ],
      "note": "While we strive to use commercially acceptable means to protect your information, no method of transmission or storage is 100% secure.",
    },
    "12": {
      "title": "12. Changes to This Privacy Policy",
      "items": [
        "We may update this Privacy Policy from time to time. If we make material changes, we will notify you via the Application or email.",
        "Please review this page periodically for the latest information. Continued use of the Application after updates means you accept the revised policy.",
      ],
    },
    "13": {
      "title": "13. Contact Us",
